  ...
  return (
    <div className="bg-promptus-surface rounded-lg p-4 flex-grow flex flex-col border border-promptus-border min-h-0">
      ...
      <div className="flex-grow flex flex-col gap-4 min-h-0">
        <label htmlFor="aiPrompt" className="sr-only">AI Prompt</label>
        <textarea id="aiPrompt" name="aiPrompt"
          ...
          className="w-full flex-grow min-h-24 max-h-40 bg-promptus-dark border border-promptus-border rounded-md p-2 text-promptus-text-primary focus:outline-none focus:ring-2 focus:ring-promptus-accent resize-none overflow-y-auto disabled:opacity-50"
